...
export default function Contactus() {
    ...
    const sendEmail = (e) => {
        e.preventDefault();
        emailjs.sendForm('service_k8bzo8p', 'template_dcfg0g9', form.current, 'dwSj0TzbTpDFQdTUe')
            .then((result) => {
                setTimeout(() => {
                            ...
                            >
                                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 mb-12">
                                    <div className="mb-12 lg:mb-0 text-center mx-auto">
                                        ...
                                        <h6 className="font-medium">JORDAN</h6>
                                    </div>
                                    <div className="mb-12 lg:mb-0 text-center mx-auto">
                                        <svg
                                            className="w-8 h-8 text-blue-600 mb-6 mx-auto"
                                        ...
                                        <h6 className="font-medium">ZARQA</h6>
                                    </div>
                                    <div className="mb-6 md:mb-0 text-center mx-auto">
                                        ...
                                        <h6 className="font-medium">+962 799634896</h6>
                                    </div>
